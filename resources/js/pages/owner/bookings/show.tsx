...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'Status Bengkel', href: '/owner/workshop-status' },
...
export default function OwnerBookingShow({ booking }: { booking: ShowBookingProps['booking'] }) {
    const availableMechanics: any[] = [];
    ...
    const submitTime = (e: React.FormEvent) => {
        e.preventDefault();
        timeForm.put(`/owner/workshop-status/${booking.id}/time`, {
    ...
    const canEditMechanics = false;
    const canAddService = false;
    ...
    const assignMechanics = () => {
        ...
        router.put(`/owner/workshop-status/${booking.id}/assign`, {
    ...
    const goToNextStatus = () => {
        ...
        router.put(`/owner/workshop-status/${booking.id}/status`, {
            status: nextStatus,
            admin_notes: '',
        }, {
            onSuccess: () => {
...
Terima kasih telah mempercayakan perawatan kendaraan Anda kepada kami! Semoga perjalanan Anda aman dan nyaman. 🙏`;
    ...
    const submitExtraService = (e: React.FormEvent) => {
        ...
        addServiceForm.post(`/owner/workshop-status/${booking.id}/service-items`, {
            preserveScroll: true,
            onSuccess: () => {
                        ...
                        <div className="relative z-10">
                            <div className="flex flex-wrap items-start justify-between gap-4 md:gap-6">
                                <div className="flex items-start gap-4">
                                    <Link href="/owner/workshop-status">
