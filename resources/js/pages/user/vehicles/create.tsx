...
import { ArrowLeft, Car, Activity, Plus } from 'lucide-react';
...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'Tambah Kendaraan', href: '/user/vehicles/create' },
];
                            ...
                            <div className="flex flex-wrap items-center gap-4">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <p className="text-blue-100">
                                        Tambahkan kendaraan baru ke akun Anda untuk booking servis
                                    </p>
                                </div>
                            </div>
                        </div>
