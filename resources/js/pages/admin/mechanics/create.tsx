...
import { ArrowLeft, Save, Activity, UserPlus } from 'lucide-react';
...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'Tambah Mekanik', href: '/admin/mechanics/create' },
];
                            ...
                            <div className="flex flex-wrap items-center gap-4">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <p className="max-w-2xl text-blue-100">
                                        Tambahkan data mekanik baru ke sistem untuk mengelola jadwal dan penugasan.
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <form onSubmit={submit} className="space-y-4">
                            ...
                            <div className="flex justify-end gap-2 pt-4 border-t border-slate-200">
                                ...
                                <Button type="submit" disabled={processing} className="bg-blue-600 hover:bg-blue-700">
                                    ...
                                    {processing ? 'Menyimpan...' : 'Simpan Mekanik'}
                                </Button>
                            </div>
                        </form>
                    </CardContent>
