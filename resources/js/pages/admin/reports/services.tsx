...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'Laporan Servis', href: '/admin/reports/services' },
];
...
export default function ServicesReport({ services, topServices, summary, filters }: ServicesReportProps) {
    const handleFilter = (e: React.FormEvent<HTMLFormElement>) => {
        ...
        window.location.href = `/admin/reports/services?${params}`;
    };
                        ...
                        <div className="relative z-10">
                            <div className="flex flex-wrap items-start justify-between gap-6">
                                ...
                                <div className="flex gap-3">
                                    <a href={`/admin/reports/services/export-pdf?date_from=${filters.date_from}&date_to=${filters.date_to}`}>
