...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'Laporan Customer', href: '/admin/reports/customers' },
];
...
export default function CustomersReport({ customers, summary, filters }: CustomersReportProps) {
    const handleFilter = (e: React.FormEvent<HTMLFormElement>) => {
        ...
        window.location.href = `/admin/reports/customers?${params}`;
    };
                        ...
                        <div className="relative z-10">
                            <div className="flex flex-wrap items-start justify-between gap-6">
                                ...
                                <div className="flex gap-3">
                                    <a href={`/admin/reports/customers/export-pdf?date_from=${filters.date_from}&date_to=${filters.date_to}`}>
