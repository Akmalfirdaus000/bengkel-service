...
import { ArrowLeft, Save, Activity, FolderPlus } from 'lucide-react';
...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'Tambah Kategori', href: '/admin/service-categories/create' },
];
...
export default function ServiceCategoryCreate() {
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="Tambah Kategori Servis" />
                            ...
                            <div className="flex flex-wrap items-center gap-4">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <p className="max-w-2xl text-blue-100">
                                        Buat kategori baru untuk mengelompokkan jenis layanan servis.
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <form onSubmit={submit} className="space-y-4">
                            ...
                            <div className="space-y-2">
                                ...
                                <Textarea
                                    ...
                                    placeholder="Deskripsi singkat kategori servis"
                                />
                            </div>
